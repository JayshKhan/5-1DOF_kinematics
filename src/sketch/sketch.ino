...
int servo_pin[SERVO_COUNT]={3};//{3,4,5,6,7,8};
int initialAngles[SERVO_COUNT]={0}; //initializing all with Zero
int currentAngles[SERVO_COUNT]={0}; //initializing all with Zero
int angles[SERVO_COUNT] = {0}; //initializing all with Zero
